...
const addServiceSchema = Yup.object().shape({
  ...
  service_duration: Yup.number()
    ...
    .max(1000, "service duration field should be less then 1000 minutes")
    .min(1, "service duration field should be more then 1 minutes"),
  service_charges: Yup.number()
    .required("service charges is required")
    .max(100000, "service charges field should be less then 1,00,000")
    .min(1, "service charges field should be more then 1"),
})
